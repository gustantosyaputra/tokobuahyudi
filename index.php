	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">TOKO BUAH YUDI</a></h1>
			</div>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Yudi, Bekasi - Jawa Barat.</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">yudi@gmail.com</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2022 Toko Buah Yudi. All rights reserved</p>
			</div>
		</div>
